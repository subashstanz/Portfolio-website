...
const PortFolioIntro = (props: Props) => {
  return (
    <section className="h-[48.313rem] w-[56.25rem] flex items-start justify-center flex-col">
      ...
      <h2 className="mb-2 font-sans font-semibold tracking-wide align-middle duration-300 ease-in text-7xl text-slate-800 ">
        Subash
      </h2>
      <div className="mb-4 font-sans text-6xl font-semibold tracking-normal align-middle text-slate-400">
        I build things for the web
      </div>
      <div className="text-lg font-normal leading-7 text-slate-400">
