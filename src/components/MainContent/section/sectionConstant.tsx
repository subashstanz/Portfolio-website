...
export const LIBRARIES_1 = ["Redux", "SCSS", "Material UI"];

export const LIBRARIES_2 = ["Ant Design", "TailWind CSS", "React Hooks"];

export const TOOLS_1 = ["Git", "python", "AWS-EC2", "AWS-S3"];
...
export const EDUCATION = [
  {
    type: "HSC",
    School:
      "Mahatma Montessori Matriculation higher secondary, school, Madurai-07",
    batch: "JUNE 2016 - MAR 2017",
    percentage: "93.91",
  },
  {
    type: "SSLC",
...
export const CERTIFICATION = [
  ...
  "Deep leaning & Neural network – Deeplearning.AI",
  "The power of Machine Learning – SAS",
  "Managing Machine Learning with google Cloud - Google",
